...
Mock.mock('/captcha', 'get', () => {
    ...
    Result.data = {
        ...
        captchaImg: Random.dataImage('100x40','p7n5a')
    }
    return Result
})
...
Mock.mock('/sys/userInfo', 'get', () => {
    ...
    Result.data = {
        id: "1",
        username: "test",
        avatar: "https://avatars.githubusercontent.com/u/94103601?s=400&u=c7391c03827c7b47bcb3d21b66da480c717d01c0&v=4"
    }
...
Mock.mock('/sys/menu/nav', 'get', () => {
    ...
    let authorities = ['sys:user:list',"sys:user:save","sys:user:delete"] //权限
